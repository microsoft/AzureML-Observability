...
az ml online-deployment create --name blue --endpoint iris-endpoint  -f realtime_score.yml --all-traffic
az ml online-deployment update --name blue --endpoint iris-endpointg  -f realtime_score.yml 
